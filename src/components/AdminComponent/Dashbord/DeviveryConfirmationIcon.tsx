...
// Figma-r moto exact Circle ebong Checkmark icon
export const DeliveryConfirmedIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg 
    className={className} 
    viewBox="0 0 24 24" 
    fill="none" 
  ...
  >
    ...
    />
    {/* Checkmark part - Circle-er bhitore thakbe */}
    <path 
      d="M17.4414 18.03L18.4514 18.99L20.5414 16.97" 
      stroke="currentColor" 
      strokeWidth="1.5" 
      strokeLinecap="round" 
      strokeLinejoin="round"
    />
    {/* Box Top */}
    <path d="M3.17188 7.43994L12.0019 12.5499L20.7719 7.46991" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    {/* Box Side/Depth */}
    <path d="M12 21.61V12.54" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    {/* Main Outer Box Shape */}
    <path 
